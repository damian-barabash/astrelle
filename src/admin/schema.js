...
// Section order (mirrors the site: home → /proces → /cennik) + human titles.
export const SECTIONS = [
  ['hero', 'Главная · Hero — шапка'],
  ['value', 'Главная · Ценность керамики'],
  ['master', 'Главная · Мастер'],
  ['booking', 'Главная · Запись и календарь'],
  ['homefacts', 'Главная · Интересные факты'],
  ['clay', 'Процесс · Гончарный круг'],
  ['process', 'Процесс · Таймлайн'],
  ['shrink', 'Процесс · Усадка'],
  ['kiln', 'Процесс · Печь'],
  ['glaze', 'Процесс · Глазуровка'],
  ['types', 'Процесс · Виды глины'],
  ['invite', 'Цены · Приглашение + адрес'],
  ['pricing', 'Цены · Прайс'],
  ['footer', 'Подвал'],
  ['nav', 'Меню и кнопки'],
...
export const FIELD_LABELS = {
  ...
  proces: 'Меню: «Процесс»',
  cennik: 'Меню: «Цены»',
  menu: 'Подпись бургер-меню',
  upcoming: 'Заголовок «Ближайшие занятия»',
  free: '«мест свободно»',
  full: '«Мест нет»',
  seats: '«мест» (после числа)',
  contact: 'Поле «контакт»',
  people: 'Поле «сколько человек»',
  comment: 'Поле «комментарий»',
  send: 'Кнопка «отправить»',
  sending: 'Подпись «отправляю…»',
  cancel: 'Кнопка «отмена»',
  ok: 'Сообщение об успехе',
  empty: 'Сообщение «нет занятий»',
  err: 'Сообщение об ошибке',
  cw: 'Подпись «коворкинг»',
  cls: 'Подпись «мастер-класс»',
  btn: 'Кнопка',
